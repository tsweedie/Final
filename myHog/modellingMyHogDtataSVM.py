...
class Tester():
    ...
    def main(self):
        ...
        filename = 'myHogfinalized_model.sav'
        pickle.dump(clf, open(filename, 'wb'))

        #AFTER SVM TRAINING:
        #clf = pickle.load(open('myHogfinalized_model.sav', 'rb'))
        print("SVM Predict:")
        ...
        print(confusion_matrix(y_test, y_pred, labels=[1,2,4,5,6,7]))
